...
export default function OnBoarding01() {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require("@/assets/images/view-people-enjoying-delicious-food-reunion-dinner-anime-style.png")}
        style={styles.imageBox}
        resizeMode="cover"
      />

      <Text style={styles.textcontent}>All your favorites</Text>
      ...
      <View style={styles.dotIndicator}>
        <DotIndicator total={3} currentIndex={0} />
